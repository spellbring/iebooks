...
Usuarios.prototype.delete = function (url, unique)
{
...
$('[data-toggle=delete-user]').on('click', function () {
    
    Global.prototype.setReloadPage(1);
    var __unique__ = $(this).attr('id');
    var __url__ = $(this).attr('data-url');
    var __idUsuario__ =  $(this).attr('data-usuario');
   
    swal({
        title: 'Usuario N° '+__idUsuario__,
    ...
    function (isConfirm) {
        if (isConfirm) {
            Usuarios.prototype.delete(__url__, __unique__);
        } else {

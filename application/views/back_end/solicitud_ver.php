                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <button class="btn btn-success btn-sm mr5 panel-remove" id="<?php echo  base64_encode($this->encrypt->encode($obj->id)); ?>" data-toggle="update-sol" data-url="<?php echo base_url('solicitud/aprobar_solicitud'); ?>" data-solicitud='<?php echo $obj->id?>'>
